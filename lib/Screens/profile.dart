                ...
                children: [
                        ...
                        children: [
                          ...
                          Column(
                            children: [
                              ...
                              Image(
                                image:
                                    AssetImage("assets/images/Groupwheel.png"),
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          "\u{20B9}${BlocProvider.of<AstrodrishtiCubitCubit>(context).state.currentUserWallet.balance.toString()}",
                          style: TextStyle(
                                          ...
                                          children: [
                                            ...
                                            Container(
                                              ...
                                              height: getheight(context,
                                                  getheight(context, 128)),
                                              width: getwidth(context,
                                                  getwidth(context, 343)),
                                              decoration: BoxDecoration(
                                                  border: Border.all(
                                                      color: Colors.white),
                                                  color: Color(0xFF161A4D),
                  ...
                  GestureDetector(
                    onTap: () {
                      ...
                      BlocProvider.of<AstrodrishtiCubitCubit>(context).reset();
